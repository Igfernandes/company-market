...
class Crypto
{
    ...
    {
        $ciphertext_raw = openssl_encrypt($pure_string, $this->cipher, $encryption_key, $options = OPENSSL_RAW_DATA, $this->iv);
    ...
    function decrypt($encrypted_string, $encryption_key)
    {
        ...
        $original_plaintext = openssl_decrypt($ciphertext_raw, $this->cipher, $encryption_key, $options = OPENSSL_RAW_DATA, $iv);
