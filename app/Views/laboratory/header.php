    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white-300">
        <div class="flex items-center justify-content-between p-4">
            ...
            <div class="ml-auto collapse navbar-collapse flex justify-content-end items-center" id="navbarSupportedContent">
                <ul class="navbar-nav me-4 mb-2 mb-lg-0 mt-2 mr-6">
                    <li class="nav-item bg-orange-400 rounded-2 py-2 px-3" data-action='status-bar'>
                        Analisando componentes
                        <i class="bi bi-arrow-clockwise spin"></i>
                    </li>
                </ul>
                 <div class="w-[20vw]">
                       <input data-search='component' class="border-2 p-2 rounded-xs w-full me-2" type="search" placeholder="Buscar componente" aria-label="Search">
                 </div>
            </div>
        </div>
    </nav>
