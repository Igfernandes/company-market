...
<div class="alter-password bg-blue-100 flex flex-col justify-center h-[100vh] w-100" id=">
    <div class="w-75 mx-auto">
        <div class="row my-4 ">
            <div class="alter-password-content col w-45 min-w-[20rem] bg-white rounded-r-lg mx-auto py-12 px-4 rounded-md shadow-lg">
