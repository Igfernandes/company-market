...
<div component='notification' class="cursor-pointer relative">
    ...
    <div component='notification:popup' data-target-popup='notifications' class="absolute right-0 min-w-[15rem] shadow bg-light pb-3 border-accent border-2 shadow rounded-md">
