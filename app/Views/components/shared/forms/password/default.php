<div class="form-group" data-password='visibility'>
    <label for="senha">
        <?= lang("Words.password") ?>
        <?= view("/components/shared/forms/tooltip/required") ?>:
    </label>
    <span class="d-none" data-password-visibility='show'>
    ...
    <span data-password-visibility='close'>
    ...
    <input type="password" name="senha" placeholder="Informe uma senha" class="form-control rounded-0" data-password-target data-label="Senha" id="senha" required>
