...
<div class="password-toggle mb-3" data-component="password-toggle" data-password='visibility'>
    <div class="input-group relative shadow-sm border-gray-200 border-2 rounded-md">
        ...
        <label class="absolute left-1 top-20 pl-1 text-black-700" data-label-toggle data-component="password-toggle:label" for="<?= $id ?? $name ?>">
            <strong>
                <?= ucfirst($label) ?>
        ...
        <div data-component="password-toggle:visibility" class="input-group-append absolute w-[.5rem] h-[.5rem] top-20 right-2 z-20 cursor-pointer fill-accent" data-password-visibility='show'>
        </div>
    </div>
