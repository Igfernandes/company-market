<div component='settings:board' data-target-popup='settings' class="absolute right-1 top-100 min-w-[16rem] shadow bg-light pt-4 pb-8 px-3 border-accent border-2 shadow rounded-md">
