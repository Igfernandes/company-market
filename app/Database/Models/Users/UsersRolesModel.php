...
class UsersRolesModel extends Model
{
    ...
    public function getUsersWithRole(array $usersQuery, array $rolesQuery = []): array
    {
        ...
        users.updated_at as user_updated_at, users.status as user_status,
        roles.name as role_name, roles.id as role_id, roles.status as role_status, roles.created_at as role_created_at,
        ...
        return array_map(function (UserRoleEntity $userRoleData) {
            ...
            $roleEntity->setStatus($attributes['role_status']);
